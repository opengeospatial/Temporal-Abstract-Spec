...
Originally developed by <<minkowski,Hermann Minkowski>> to support work in Special Relativity, the concept of spac-etime is useful whenever the location of an object in space is dependent on its location in time.
