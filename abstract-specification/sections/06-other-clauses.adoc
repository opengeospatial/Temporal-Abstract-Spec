...
ReferenceSystem "1" <|-- "0..*" SpatialReferenceSystem : is a
ReferenceSystem "1" <|-- "0..*" TemporalReferenceSystem : is a
...
note for TemporalReferenceSystem "Note: Consists of one only of:\nTemporalCoordinateReferenceSystem,\nCalendar, or \nOrdinalTemporalReferenceSystem"
    TemporalReferenceSystem "0..1" <|-- "1" TemporalCoordinateReferenceSystem : is a
    TemporalReferenceSystem "0..1" <|-- "1" Calendar : is a
    TemporalReferenceSystem "0..1" <|-- "1" OrdinalTemporalReferenceSystem : is a
