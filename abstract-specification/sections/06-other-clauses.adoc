...
TemporalCoordinateReferenceSystem "1" o-- "1" Epoch : has a
TemporalCoordinateReferenceSystem "1" --> "1..*" Notation
Calendar "1" o-- "0..1" Epoch : has a
Calendar "1" o-- "1..*" Timescale
Calendar "1" o-- "1" Algorithm
Calendar "1" --> "1..*" Notation
OrdinalTemporalReferenceSystem "1" o-- "0..1" Epoch : has a
OrdinalTemporalReferenceSystem "1" o-- "2..*" Event : Consists of
