...
ApplicableLocationOrDomain "0..1" o-- "1" OrdinalTemporalReferenceSystem
ApplicableLocationOrDomain "0..1" o-- "1" Calendar
ApplicableLocationOrDomain "0..1" o-- "1" TemporalCoordinateReferenceSystem
```
