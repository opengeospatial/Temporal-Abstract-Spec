...
include::sections/07-temporal_abstract_model.adoc[]

include::sections/08-temporal_regimes.adoc[]

include::sections/09-notation.adoc[]

include::sections/10-attributes.adoc[]

include::sections/11-sync-clocks.adoc[]

// TODO: RT: propose to use dynamic generation of MBS
include::sections/12-data_dictionary.adoc[]
